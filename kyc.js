/* webapp/kyc.js (v105.0) - نسخه بازنگری شده و کامل */
(function () {
    'use strict';
    ...
    // آدرس دهی ماژولار هماهنگ با سرور جدید
    ...
    window.onload = async function() {
        try {
            ...
            console.log("WebApp Ready Error:", e);
        }
    ...
    async function fetchUserStatus() {
        try {
            ...
            const res = await fetch(`${API_BASE_URL}/get_user_data?t=${timestamp}`, {
                method: 'POST',
                headers: {
    ...
    window.handleFileSelect2 = function(input, type) { window.handleFileSelect(input, type, 2); };
    ...
    async function submitLevel1() {
        ...
        try {
            const res = await fetch(`${API_BASE_URL}/submit_kyc_lite`, {
                method: 'POST',
                body: formData,
    ...
    async function submitLevel2() {
        ...
        try {
            const res = await fetch(`${API_BASE_URL}/submit_full_kyc`, {
                method: 'POST',
                body: formData,
                headers: { 'ngrok-skip-browser-warning': 'true' }
            });
